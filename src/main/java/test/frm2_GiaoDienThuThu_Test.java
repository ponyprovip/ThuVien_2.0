 ...
 * @author DIENMAYXANH
 */
public class frm2_GiaoDienThuThu_Test extends javax.swing.JFrame {

    public frm2_GiaoDienThuThu_Test() {
        initComponents();
        show_Sach();
        show_BDoc();
        show_DSMuon();
...
//        txtNgayT.setVisible(false);
    ...
    public ArrayList<TraSach> trasachList = new ArrayList<>();
    ...
    public String regexEmail = "^[a-zA-Z0-9]+[@]{1}+[a-zA-Z]+[.]{1}+[a-zA-Z]+$";
    public String regexSDT = "^0\\d{9}$";
    public String regexSoluong = "^[0-9]+$";
    //public int SL1 = Integer.parseInt(txtSL_M.getText());
    ...
    private void initComponents() {
        ...
        Home_Page.setBackground(new java.awt.Color(228, 230, 235));
        ...
        lbrSoluong_T.setToolTipText("Haha vai");
        ...
        panelRound7Layout.setHorizontalGroup(
            ...
            .addGroup(panelRound7Layout.createSequentialGroup()
                ...
                .addGroup(panelRound7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lbrMaBD_T, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lbrTenBD_T, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lbrMasach_T, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                ...
                .addGroup(panelRound7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lbrNgayM_T, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
        ...
        panelRound7Layout.setVerticalGroup(
            ...
            .addGroup(panelRound7Layout.createSequentialGroup()
                ...
                .addGroup(panelRound7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbrTenBD_T, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panelRound7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel51)
                    .addComponent(jLabel55))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelRound7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lbrMasach_T, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                    .addComponent(lbrNgayT_T, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel52)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(panelRound7Layout.createSequentialGroup()
                ...
                .addGroup(panelRound7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelRound7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
        ...
        xLoiMP.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
    ...
    private void btnSuaNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaNActionPerformed
        ...
        String value = (tblBDoc.getModel().getValueAt(row, 0).toString());
...
//        txtNgayT_M.setVisible(false);
          Date d = new Date();
          txtNgayM_M.setDate(d);
          txtNgayT_M.setDate(d);
          txtNgayM_M.setEnabled(false);
          txtNgayT_M.setEnabled(false);
...
//        txtNgayT_M.setVisible(true);
          txtNgayM_M.setDate(null);
          txtNgayT_M.setDate(null);
          txtNgayM_M.setEnabled(true);
          txtNgayT_M.setEnabled(true);
...
//        String t2 = "Mã bạn đọc không khớp!";
        ...
        if(txtMasach_M.getText().equals("")){
            ...
            if(txtMaBD_M.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Bạn chưa điền mã bạn đọc");
            return;
        }else{
            ...
            JOptionPane.showMessageDialog(this, "Bạn chưa lựa chọn hình thức mượn");
            return;
        }else{
            if(txtNgayM_M.getDate()==null){
            JOptionPane.showMessageDialog(this, "Bạn chưa chọn ngày mượn");
            return;
        }else{
            if(txtNgayT_M.getDate()==null){
            JOptionPane.showMessageDialog(this, "Bạn chưa chọn ngày trả");
            return;
        }else{
            ...
            JOptionPane.showMessageDialog(this, "Mã bạn đọc không đúng");
            return; 
        }else{
            ...
            if((txtNgayM_M.getDate()).before(d)){
            JOptionPane.showMessageDialog(this, "Ngày mượn không được nhỏ hơn ngày thực tế");
            return; 
        }else{
            if(txtNgayT_M.getDate().before(d)){
            JOptionPane.showMessageDialog(this, "Ngày trả không được nhỏ hơn ngày thực tế");
            return;
        }else{
            if(txtNgayT_M.getDate().before(txtNgayM_M.getDate())){
            JOptionPane.showMessageDialog(this, "Ngày trả không được nhỏ hơn ngày mượn");
            return;
                      }
                     }
                    }
            ...
            try {
                ...
                if(chb1.isSelected()){
                    ...
                    String dd = df.format(txtNgayM_M.getDate());
                    String dd1 = df.format(txtNgayT_M.getDate());
                    ps.setString(6, dd);
                    ps.setString(7,dd1);
                }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if(txtMaPM_T.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Bạn chưa điền mã phiếu mượn");
            return;
        }else{
            if(!(chb3.isSelected()|chb4.isSelected())){
            JOptionPane.showMessageDialog(this, "Bạn chưa lựa chọn tình trạng sách");
            return;
        }else{
            if(!(chb5.isSelected()|chb6.isSelected())){
            JOptionPane.showMessageDialog(this, "Bạn chưa lựa chọn thời gian trả sách");
            return;
        }else{
            if(txtNgayT.getDate()==null){
            JOptionPane.showMessageDialog(this, "Bạn chưa lựa chọn ngày trả sách thực tế");
            return;
              }
            }
          }
        ...
        try {
            ...
            ResultSet rs = ps1.executeQuery();
            if(rs.next()){
                JOptionPane.showMessageDialog(this, "Phiếu mượn này đã được hoàn thành");
                return;
            }else{
            ps.executeUpdate();
            UpdateSL_T();
   ...
   /**
    ...
    //String Date1 = df1.format(txtNgayM_M.getDate());
    public void Reset(){
        txtTensach.setText(null);
        txtTacgia.setText(null);
        txtSoluong.setText(null);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm2_GiaoDienThuThu_Test().setVisible(true);
            }
        });
    }
   ...
   private void resetColor(JPanel[] pane , JPanel[] x){
    ...
    public com.toedter.calendar.JDateChooser txtNgayM_M;
